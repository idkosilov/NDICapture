...
This software is released under the MIT license. See the [LICENSE](https://github.com/idkosilov/WindowCaptureToNDI/blob/master/LICENSE.md) file for more information.
